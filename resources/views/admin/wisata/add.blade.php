                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label>Nama Wisata</label>
                                <input name="nama_wisata" class="form-control" placeholder="Nama Wisata">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            <label>Deskripsi Wisata</label>
                                <textarea name="deskripsi" class="form-control" placeholder="Deskripsi Wisata" rows="5"></textarea>
                                <div class="text-danger">
                                    @error('deskripsi')
                                        {{ $message }}
                                    @enderror
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label>Alamat Wisata</label>
                                <input name="alamat" class="form-control" placeholder="Alamat Wisata">
                                <div class="text-danger">
                                    @error('alamat')
                                        {{ $message }}
                                    @enderror
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label>Posisi Wisata</label>
                                <input name="posisi" id="posisi" class="form-control" placeholder="Posisi Wisata">
                                <div class="text-danger">
                                    @error('posisi')
                                        {{ $message }}
                                    @enderror
...
<script>
    ...
    var map = L.map('map', {
        center  : [-7.666583793930358, 112.46647308047852],
        zoom    : 10,
        layers  : [peta1],
    });
    ...
    var curLocation = [-7.666583793930358, 112.46647308047852];
